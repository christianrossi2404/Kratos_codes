...
##                    node.SetSolutionStepValue(VELOCITY,i,vel)
    ...
    def InitializeSolutionStep(self):
        super(NavierStokesSolver_VMSMonolithic, self).SolverInitializeSolutionStep()
    #
    def Predict(self):
        super(NavierStokesSolver_VMSMonolithic, self).SolverPredict()

    def SolveSolutionStep(self):
        super(NavierStokesSolver_VMSMonolithic, self).SolverSolveSolutionStep()

    def FinalizeSolutionStep(self):
        super(NavierStokesSolver_VMSMonolithic, self).SolverFinalizeSolutionStep()
